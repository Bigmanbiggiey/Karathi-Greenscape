...
const Home = () => {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      <Helmet>
        <title>Karathi Greenscape | Wholesale & Retail Plants & Landscaping</title>
        <meta
          name="description"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                name: "Indoor Plants",
                desc: "Perfect for homes and offices.",
              },
              {
                name: "Outdoor Shrubs",
                desc: "Ideal for landscaping projects.",
              },
              {
                name: "Flowering Plants",
                desc: "Brighten up any space with color.",
              },
            ].map((product, idx) => (
              <div
                key={idx}
